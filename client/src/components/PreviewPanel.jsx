            ...
            !isLoading && thumbnail?.image_url && (
                <div className="group relative h-full w-full">
                    ...
                    <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
                        <button onClick={onDownload} type="button" className="mb-6 flex items-center gap-2 rounded-md px-5 py-2.5 text-xs font-medium transition bg-white/30 ring-white/40 backdrop-blur hover:scale-105 active:scale-95">
                           <p className="text-sm text-zinc-200">Download</p>
