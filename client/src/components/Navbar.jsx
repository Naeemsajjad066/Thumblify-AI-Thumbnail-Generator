                        ...
                        isLoggedIn ? (
                            <div className="relative group">
                                ...
                                <div className="absolute hidden group-hover:block top-6 right-0 pt-4">
                                    <button onClick={() => logout()} disabled={loading} className="bg-white/20 border-2 border-white/10 px-5 py-1.5 rounded disabled:opacity-50 disabled:cursor-not-allowed">
