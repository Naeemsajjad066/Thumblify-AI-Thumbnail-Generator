...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to="/">
                    <img className="size-12 aspect-square" src="/favicon.svg" alt="footer logo" width={32} height={32} />
                </Link>
            ...
            >
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">Thumblify - Naeem Sajjad</a></p>
            </motion.div>
        </footer>
    );
}