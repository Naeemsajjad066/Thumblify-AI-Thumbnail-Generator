    ...
    <>
      ...
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-zinc-400 my-1">View and Manage all your Ai generated Thumbnails</p>
        </div>
          ...
          <div className="columns-1 sm:columns-2 lg:columns-3 2xl:columns-4 gap-8 ">
            {
              thumbnails.map((thumb) => {
                ...
                return (
                  <div key={thumb._id} onClick={() => navigate(`/generate/${thumb._id}`)} className="mb-8 group relative cursor-pointer rounded-2xl bg-white/6 broder border-white/10 transition shadow-xl break-inside-avoid">
                    {/* Image */}
                    ...
                    <div onClick={(e)=>e.stopPropagation()} className=" absolute bottom-2 right-2 max-sm:flex sm:hidden group-hover:flex gap-1.5" >
                      ...
                      <button 
                        ...
                        disabled={deletingId === thumb._id}
                        className="size-6 bg-black/50 p-1 rounded hover:bg-pink-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <TrashIcon className="size-4" />
                      </button>
                      
                      <button onClick={()=>handleDownload(thumb.image_url)} className="size-6 bg-black/50 p-1 rounded hover:bg-pink-600 transition-all">
