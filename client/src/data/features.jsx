...
export const featuresData = [
    {
        ...
        description: "Our AI analysis video content to suggest the most clickable concpets.",
    },    {
        icon: "/assets/thumb-icon.svg",
        title: "Eye-Catching Designs",
        description: "Generate vibrant, hight contrast thumbnails that stand out in the feed.",
    },
    {
